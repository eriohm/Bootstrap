...
namespace Bootstrap
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        protected void ListBoxContacts_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Person myPerson = contactlist.Find(p => p.id == contactID);

            TextBoxFirstName.Text = myPerson.fName;
            TextBoxLastName.Text = myPerson.lName;
            TextBoxSSN.Text = myPerson.ssn;
        ...
        protected void ButtonOk_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = $"update contact set firstName='{TextBoxFirstName.Text}',lastName='{TextBoxLastName.Text}',SSN='{TextBoxSSN.Text}' where contactID={Convert.ToInt32(contactID)}";
